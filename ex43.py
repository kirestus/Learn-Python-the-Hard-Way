...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		print "your entire crew. You are the last survivning member and your last"
		print "mission is to get the neutron destruct bomb from the Weapons Armory,"
		print "put it in the bridge, and blow the ship up after getting into an "
		print "escape pod."
		print "\n"
		print "You're running down the central corridor to the Weapons Armorty when"
		...
		if action == 'shoot':
			...
			print "makes him fly into an insaine fit of rage and blast you repeatedly in the face untill"
			print "you are dead. Then he eats you."
			return 'death'
			
		elif action == 'dodge':
			print "Like a world class boxer you dodge, weve, slip and slide right"
			print "as the Gothon's blaster cranks a laser past your head."
			print "In the middle of your artful dodge your foot slips and you"
			print "bang your head on the metal wall and pass out"
			print "you wake up shortly after only to die as a Gothon stomps on"
			...
			print "putting him down, then jump through the Weapon Armory do or."
...
class EscapePod(Scene):
	...
	def enter(self):
		print "You rush through the ship desperatley trying to make it to"
